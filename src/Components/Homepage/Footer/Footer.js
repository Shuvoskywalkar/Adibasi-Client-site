...
const Footer = () => {
    return (
        <div id="Footer" className="Heropage min-h-screen">
            ...
            <div className=" px-md-5 py-3 px-3  ">
           
           <div className=" text-center row text-light">

           <div className="col-md-6 text-white  text-md-center  pl-5">
           ...
           <div className="col-md-6  pl-5 py-2 text-center">
               <div>
